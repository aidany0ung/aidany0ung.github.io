...
class Renderer{
    ...
    */
    setUniformData(model, camera, shaderData){
        ...
        let camPosLoc = gl.getUniformLocation(this.program, "u_viewPos")
        gl.uniform3fv(camPosLoc, camPos.toFloat32());

        let lightColLoc = gl.getUniformLocation(this.program, "u_lightColor");
